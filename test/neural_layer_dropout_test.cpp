...
#include "../xcsf/neural_layer_dropout.h"
...
TEST_CASE("NEURAL_LAYER_DROPOUT")
{
    /* Test initialisation */
    struct XCSF xcsf;
    ...
    double *out = neural_layer_dropout_output(l);
    ...
    /* Test update */
    neural_layer_dropout_update(l);

    /* Test copy */
    struct Layer *l2 = neural_layer_dropout_copy(l);
    ...
    /* Test mutate */
    CHECK_EQ(neural_layer_dropout_mutate(l), false);

    /* Test randomisation */
    neural_layer_dropout_rand(l);
