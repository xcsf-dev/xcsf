...
LAYER *neural_layer_softmax_init(const XCSF *xcsf, int n_inputs,
                                 double temperature);
LAYER *neural_layer_softmax_copy(const XCSF *xcsf, const LAYER *src);
void neural_layer_softmax_rand(const XCSF *xcsf, LAYER *l);
void neural_layer_softmax_forward(const XCSF *xcsf, const LAYER *l,
                                  const double *input);
void neural_layer_softmax_backward(const XCSF *xcsf, const LAYER *l,
                                   const double *input, double *delta);
void neural_layer_softmax_update(const XCSF *xcsf, const LAYER *l);
void neural_layer_softmax_print(const XCSF *xcsf, const LAYER *l,
                                _Bool print_weights);
